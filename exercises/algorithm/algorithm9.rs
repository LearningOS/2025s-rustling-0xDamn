    ...
    T: Default,
{
    ...
    fn smallest_child_idx(&self, idx: usize) -> usize {
        ...
        // If no children exist, return the current index
        ...
        // Compare left and right children using the heap's comparator
    ...
    T: Default,
{
    ...
    fn next(&mut self) -> Option<T> {
        ...
        // Extract the root (min or max depending on the heap type)
